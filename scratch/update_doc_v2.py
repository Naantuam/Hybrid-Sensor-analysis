...
def build_chapter_3():
    ...
    # Locate Chapter 3 start and Chapter 4 start
    p3_idx = None
    p4_idx = None
    for i, p in enumerate(doc.paragraphs):
        if p.text.strip().upper() == 'CHAPTER THREE':
            p3_idx = i
        elif p.text.strip().upper() == 'CHAPTER FOUR' and p3_idx is not None:
            p4_idx = i
            break

    print(f"Chapter 3 index: {p3_idx}, Chapter 4 index: {p4_idx}")

    target_p = doc.paragraphs[p4_idx]
    ...
    add_heading_3("3.2.1 Phase 1: Problem Identification and Motivation")
    ...
    add_heading_3("3.2.2 Phase 2: Definition of Solution Objectives")
    ...
    add_heading_3("3.2.3 Phase 3: Design and Development")
    ...
    add_heading_3("3.2.4 Phase 4: Demonstration")
    ...
    add_heading_3("3.2.5 Phase 5: Evaluation")
    ...
    add_heading_3("3.2.6 Phase 6: Communication")
    ...
    add_heading_3("3.3 Experimental Setup and Technical Specifications")
    ...
    add_heading_3("Table 3.1: Hardware Testbed and Environment Specifications")
    add_table(
    ...
    add_heading_3("Table 3.2: Software Stack and System Tooling Versions")
    add_table(
    ...
    add_heading_3("3.4 System Requirements and Target Justifications")
    ...
    add_heading_3("Table 3.3: System Functional Requirements")
    add_table(
    ...
    add_heading_3("Table 3.4: Non-Functional Requirements and Target Justifications")
    add_table(
    ...
    add_heading_3("3.5 System Architecture, Diagrams, and Operational Workflows")
    ...
    add_heading_3("3.5.1 System Architecture Topology")
...
Figure 3.1: Hybrid Sensor Monitoring Framework High-Level Architecture Topology"""
    ...
    add_heading_3("3.5.2 System Use Case Analysis")
...
Figure 3.2: System Use Case Diagram for Hybrid Sensor Monitoring Framework"""
    ...
    add_heading_3("3.5.3 Data Flow Diagram (DFD Level 1)")
...
Figure 3.3: Level 1 Data Flow Diagram (DFD) for Telemetry Processing"""
    ...
    add_heading_3("3.5.4 Telemetry Event Sequence Diagram")
...
Figure 3.4: Sequence Diagram for Telemetry Processing and Threat Alerting"""
    ...
    add_heading_3("3.5.5 Operational Deployment Modes")
    ...
    add_heading_3("3.6 Technical Threat Engine, Algorithm, and MITRE ATT&CK Mapping")
    ...
    add_heading_3("3.6.1 Four-Technique Threat Scoring Engine")
    ...
    add_heading_3("3.6.2 Threat Evaluation Algorithm")
...
10. Return { TotalScore, ThreatLevel, TriggeredRules }"""
    ...
    add_heading_3("3.6.3 MITRE ATT&CK Mobile Threat Matrix")
    add_body("Table 3.5 maps the framework's threat rules to corresponding MITRE ATT&CK Mobile techniques.")

    add_heading_3("Table 3.5: Threat Matrix Mapped to MITRE ATT&CK Mobile Framework")
    add_table(
    ...
    add_heading_3("3.7 Database Design, Schema, and Synchronization Protocols")
    ...
    add_heading_3("3.7.1 Database Entity-Relationship (ER) Architecture")
...
Figure 3.5: Entity-Relationship (ER) Schema Diagram"""
    ...
    add_heading_3("3.7.2 Database Schema Definitions")
    add_body("Table 3.6 details the relational database schema definitions implemented across SQLite and PostgreSQL.")

    add_heading_3("Table 3.6: Relational Database Schema Specifications")
    add_table(
    ...
    add_heading_3("3.7.3 Asynchronous Offline Buffer Synchronization Routine")
    ...
    add_heading_3("3.8 System Evaluation Plan")
    ...
    add_heading_3("3.8.1 Evaluation Metrics")
    ...
    add_heading_3("3.8.2 Synthetic Attack Test Suite")
    add_body("Table 3.7 lists the synthetic attack scenarios designed to evaluate the threat engine.")

    add_heading_3("Table 3.7: Synthetic Attack Test Suite for System Evaluation")
    add_table(
    ...
    # Remove old placeholder paragraphs
    found_ch3 = False
    ...
    print(f"Removing {len(paragraphs_to_remove)} old paragraphs...")
